...
import com.yf.base.IWindowInsetLayout;
import com.yf.base.utils.WindowInsetHelper;
 ...
 *
 */
public class BaseWindowInsetLayout extends FrameLayout implements IWindowInsetLayout {
    private WindowInsetHelper mQMUIWindowInsetHelper;

    public BaseWindowInsetLayout(Context context) {
        this(context, null);
    }

    public BaseWindowInsetLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaseWindowInsetLayout(Context context, AttributeSet attrs, int defStyleAttr) {
