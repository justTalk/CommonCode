...
import com.yf.base.utils.DisplayHelper;
import com.yf.base.utils.StatusBarHelper;
import com.yf.base.widget.BaseWindowInsetLayout;

import java.lang.reflect.Field;

public abstract class BaseFragmentActivity extends AppCompatActivity {
    private static final String TAG = "QMUIFragmentActivity";
    private BaseWindowInsetLayout mFragmentContainer;
    ...
    public int startFragmentAndDestroyCurrent(final BaseFragment fragment, final boolean useNewTransitionConfigWhenPop) {
        ...
        INotchInsetConsumer.Utils.findAndModifyOpInBackStackRecord(fragmentManager, -1, new INotchInsetConsumer.Utils.OpHandler() {
            @Override
    ...
    public int replaceFragment(BaseFragment fragment) {
        Log.i(TAG, "startFragment");
        BaseFragment.TransitionConfig transitionConfig = fragment.onFetchTransitionConfig();
        String tagName = fragment.getClass().getSimpleName();
        return getSupportFragmentManager()
